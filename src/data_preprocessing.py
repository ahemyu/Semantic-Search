...
def preprocess_data(file_path: str) -> str:
    ...
    cols: List[str] = ['Description', 'Marketing_Text', 'Typical_Use_Cases']  # Only clean the columns containing long sentences
    for col in cols:
    ...
    cleaned_file_path: str = '../data/cleaned_electronic_devices.csv'
