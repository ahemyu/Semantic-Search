...
- **main.py**:  
    ...
    This script serves as the main entry point for the Semantic Search application, tying together data preprocessing, embedding generation, and search functionalities into a simple UI.   
